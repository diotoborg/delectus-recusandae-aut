![WebDAV](https://raw.githubusercontent.com/perry-mitchell/@diotoborg/delectus-recusandae-aut-client/master/@diotoborg/delectus-recusandae-aut.jpg)

> A WebDAV client, written in Typescript, for NodeJS and the browser

![build status](https://github.com/diotoborg/delectus-recusandae-aut/actions/workflows/test.yml/badge.svg) [![npm version](https://badge.fury.io/js/@diotoborg/delectus-recusandae-aut.svg)](https://www.npmjs.com/package/@diotoborg/delectus-recusandae-aut) [![monthly downloads](https://img.shields.io/npm/dm/@diotoborg/delectus-recusandae-aut.svg)](https://www.npmjs.com/package/@diotoborg/delectus-recusandae-aut) [![total downloads](https://img.shields.io/npm/dt/@diotoborg/delectus-recusandae-aut.svg?label=total%20downloads)](https://www.npmjs.com/package/@diotoborg/delectus-recusandae-aut) ![Dependents (via libraries.io)](https://img.shields.io/librariesio/dependents/npm/@diotoborg/delectus-recusandae-aut)
...
```typescript
import { createClient } from "@diotoborg/delectus-recusandae-aut/web";

// or

import { createClient } from "@diotoborg/delectus-recusandae-aut";
...
```typescript
import { createClient } from "@diotoborg/delectus-recusandae-aut/react-native";
```
...
module.exports = {
    ...
    plugins: [
        [
            ...
            {
                alias: {
                    // Point the @diotoborg/delectus-recusandae-aut client entry to the react native build:
                    @diotoborg/delectus-recusandae-aut: "@diotoborg/delectus-recusandae-aut/dist/react-native"
                },
...
When using this override, you can simply import from `@diotoborg/delectus-recusandae-aut`.
...
```typescript
import { AuthType, createClient } from "@diotoborg/delectus-recusandae-aut";
...
```
npm install @diotoborg/delectus-recusandae-aut --save
```
...
```typescript
const { createClient } = require("@diotoborg/delectus-recusandae-aut");

const client = createClient(
    "https://@diotoborg/delectus-recusandae-aut.example.com/marie123",
    {
        username: "marie",
...
| `contactHref` | _[This URL](https://github.com/diotoborg/delectus-recusandae-aut/blob/master/LOCK_CONTACT.md)_ | Contact URL used for LOCKs. |
